...
# MIGRATION COMPARE — side-by-side review dir for the plotter migration.
# Remove this constant and the legacy plot calls in render_combined once
# the new output is approved.
COMPARE_DIR = Path("plots/_migration_compare/multimodal_rotated")
